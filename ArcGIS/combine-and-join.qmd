...
![Use the EVT raster to mask your BpS raster. Remember to set appropriate environment settings.](../images/13-combine-tool.png){fig-alt="The ArcGIS Pro window showing the location of the Combine tool within the geospatial toolbox. The tool is in Spatial Analyst Tools, Local, Combine."}
