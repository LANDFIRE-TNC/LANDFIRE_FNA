...
:::callout-important
If you prefer to work in an automated format, we have created an **[ArcGIS Pro toolbox](data/Fire Needs Assessment Tools.zip)** (downloads a zip file) and an **[ArcPy enabled Jupyter Notebook](data/Fire Needs Assessment Python.zip)** (downloads a zip file) for each step of this workflow from data processing throught table export. It is still recommended that you follow the guidance written on each FNA Process page as you run the tools so that you better understand the process and do not miss important context for what the tool is asking you to input in each box. The toolbox has simply been provided for your convenience should you choose to use it.
